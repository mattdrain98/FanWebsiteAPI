...
namespace FanWebsiteAPI.Migrations
{
    ...
    [Migration("20260904190446_AddChatMessageIsSystem")]
    partial class AddChatMessageIsSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FanWebsiteAPI.Models.Chat.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FanWebsiteAPI.Models.Chat.ChatParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FanWebsiteAPI.Models.Notification.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FanWebsiteAPI.Models.Posts.PostImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FanWebsiteAPI.Models.Report.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FanWebsiteAPI.Models.Report.Report", b =>
                {
                    b.HasOne("Fan_Website.ApplicationUser", "Reporter")
                        .WithMany()
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Fan_Website.ApplicationUser", "ReviewedBy")
                        .WithMany()
                        .HasForeignKey("ReviewedById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Fan_Website.ApplicationUser", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Fan_Website.Models.ProfileComment.ProfileComment", b =>
                {
                    b.HasOne("Fan_Website.ApplicationUser", "CommentUser")
                        .WithMany("CommentsMade")
                        .HasForeignKey("CommentUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Fan_Website.ApplicationUser", "ProfileUser")
